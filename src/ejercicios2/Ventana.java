...
public class Ventana extends JFrame{
	...
	private void iniciarComponentes() {
		...
		tfDNIM.setBounds(344, 298, 136, 20);
		...
		btnBuscar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					if(gest.dniEncontrado(tfDNIM.getText())) {
						String[] datos=gest.datosDNI(tfDNIM.getText());
						tfNombreM.setText(datos[0]);
						tfApellidoM.setText(datos[1]);
						tfSueldoM.setText(datos[2]);
						tfDiaM.setText(datos[3].substring(0, 2));
						tfMesM.setText(datos[3].substring(3, 5));
						tfAnyoM.setText(datos[3].substring(6, 10));
						tfMatriculaM.setText(datos[4]);
					}
					else {
		...
		btnModificar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				String dia=tfDiaM.getText();
				String mes=tfMesM.getText();
				String anyo=tfAnyoM.getText();
				String fecha=anyo+"-"+mes+"-"+dia;
				try {
					gest.modificarTrabajador(tfDNIM.getText(), tfNombreM.getText(), tfApellidoM.getText(), tfSueldoM.getText(), fecha, tfMatriculaM.getText());
					JOptionPane.showMessageDialog(null, "Usuario modificado correctamente");
					tp.setText(gest.verTrabajadores());
					vaciarCamposM();
				} catch (SQLException e1) {
					JOptionPane.showConfirmDialog(null, "Datos introducidos no validos");
				}
			}
	...
	/**
	 * Metodo para limpiar los campos de dar alta al trabajador
	 */
	...
	/**
	 * Metodo para limpiar los campos de modificar al trabajador
	 */
	private void vaciarCamposM() {
		tfDNIM.setText("");
		tfNombreM.setText("");
		tfApellidoM.setText("");
		tfSueldoM.setText("");
